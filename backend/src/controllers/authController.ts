import { controller, httpPost, httpGet, requestBody, BaseHttpController } from 'inversify-express-utils';
...
export class AuthController extends BaseHttpController {
  ...
  private async getCurrentUser() {
    const accessToken = this.httpContext.request.cookies[Cookie.ACCESS_TOKEN];
